...
model = keras.models.load_model(r"D:\Python\Fakenewsdetection\models\model.h5")
doc=Doc2Vec.load(r"D:\Python\Fakenewsdetection\models\my_doc2vec_model")
